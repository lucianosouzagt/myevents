...
// Landing Page (Redirect to My Events)
Route::get('/', function () {
...
// Public RSVP
Route::get('/rsvp/{token}', [InvitationController::class, 'show'])->name('invitations.show'); // Alias for shorter URL
Route::post('/rsvp/{token}', [InvitationController::class, 'rsvp'])->name('invitations.rsvp.store');
